...
import com.example.a84064.eatapp.Adapter.PoiAdapter;
 ...
 */
public class PointActivity extends AppCompatActivity implements View.OnClickListener, BDLocationListener, OnGetGeoCoderResultListener, BaiduMap.OnMapStatusChangeListener, TextWatcher {
    public static final String POINT_NAME="com.example.a84064.eatapp.AccountPage.point_name";
    public static final String POINT_LOCAL="com.example.a84064.eatapp.AccountPage.point_local";
    public static final String STREET_NAME="com.example.a84064.eatapp.AccountPage.street_name";

    private TextureMapView mMapView;
    private BaiduMap mBaiduMap;
    private ListView poisLL;
    private ImageButton point_back;
    ...
    private RelativeLayout topRL;       //界面上方布局
    private EditText searchAddress;     //搜索地址输入框
    private ListView searchPois;        //搜索输入框对应的ListView
    ...
    Handler handlerShowStreet = new Handler() {
        public void handleMessage(Message msg) {
            searchAddress.setText(name);
        }
    };
    public void init(){
        point_back=(ImageButton) findViewById(R.id.PointAddress_back) ;
        point_back.setOnClickListener(this);
        ...
        if(bundle!=null) {
            name = bundle.getString(STREET_NAME);
    ...
    private void setPointResult(String n,String p){
        Intent data=new Intent();
        data.putExtra(POINT_NAME,n);
        data.putExtra(POINT_LOCAL,p);
    ...
    public void onGetReverseGeoCodeResult(ReverseGeoCodeResult reverseGeoCodeResult) {
        ...
        final PoiAdapter poiAdapter = new PoiAdapter(PointActivity.this, poiInfos);
        poisLL.setAdapter(poiAdapter);
        poisLL.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) {
                street=poiAdapter.getStreet(arg2);
                point=poiAdapter.getPoint(arg2);
                setPointResult(street,point);
            }
        });
    }
        ...
        if (s.length() == 0 || "".equals(s.toString())) {
            ...
            poiSearch.setOnGetPoiSearchResultListener(new OnGetPoiSearchResultListener() {
                ...
                public void onGetPoiResult(PoiResult poiResult) {
                    ...
                    if(poiInfos!=null) {
                        final PoiSearchAdapter poiSearchAdapter = new PoiSearchAdapter(PointActivity.this, poiInfos, locationLatLng);
                        ...
                        searchPois.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                            @Override
                            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                                street = poiSearchAdapter.getStreet(arg2);
                                point = poiSearchAdapter.getPoint(arg2);
                                setPointResult(street, point);
