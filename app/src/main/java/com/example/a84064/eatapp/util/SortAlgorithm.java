...
public class SortAlgorithm {
     ...
     * @param y
     */
    private static <E> void swapElement(List<E> rawDatas, double[] condition, int x, int y) {
     ...
     */
    public static <E> void exchangeSort(List<E> rawDatas, double[] condition, String sortType) {
     ...
     * @param sortType 排序类型 正序"asc"/倒序"desc"
     */
    public static <E> void insertSort(List<E> rawDatas, double[] condition, String sortType) {
        if (sortType.equals("asc")) {
            for (int i = 1; i < condition.length; i++) {
                for (int j = 0; j < i; j++) {
