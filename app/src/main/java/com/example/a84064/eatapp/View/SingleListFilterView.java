...
public class SingleListFilterView extends RelativeLayout implements ViewBaseAction {
     ...
     * 数据集合，构造时传入
     */
    private List<Shop_Type.type_value> data;// 显示字段
    /**
     * 监听实现接口
     */
     ...
     *            默认显示的文本
     */
    public SingleListFilterView(Context context, List<Shop_Type.type_value> data, String show) {
        super(context);
        this.showText = show;
        this.data = data;
        init(context);
    ...
    private void init(Context context) {
        ...
        // 设置数据
        TextAdapter listViewAdapter = new TextAdapter(context, data, true,1);
